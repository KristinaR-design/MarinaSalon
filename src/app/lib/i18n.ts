export const translations = {
  de: {
    ...
    features: { one: "Gel Nägel", two: "Präzise Sugaring-Technik", three: "Entspannende Wellness-Rituale", four: "Paraffinbäder", five: "Saisonale Angebote" },
    services: { title: "Leistungen & Preise", female: "Damen", male: "Herren", face: "Süße Gesichtsbehandlung", nails: "Nägel" },
  ...
  ru: {
    ...
    features: { one: "Гелевое покрытие", two: "Точная техника шугаринга", three: "Расслабляющие wellness-ритуалы", four: "Парафиновые ванны", five: "Сезонные предложения" },
    services: { title: "Услуги и цены", female: "Женщины", male: "Мужчины", face: "Сладкая уходовая процедура", nails: "Ногти" },
  ...
  en: {
    ...
    features: { one: "Gel nails", two: "Precise sugaring technique", three: "Relaxing wellness rituals", four: "Paraffin baths", five: "Seasonal offers" },
    services: { title: "Services & Prices", female: "Women", male: "Men", face: "Sweet facial treatment", nails: "Nails" },
